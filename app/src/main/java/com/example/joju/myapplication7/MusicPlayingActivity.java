...
//    JSONArray recent_array = new JSONArray();
    JSONArray recent_array;
    JSONObject jObject;


//    String aaa = "Aaa";
  //  String path = new String("/sdcard/Samsung/Music/Beatles-Yesterday.mp3");
     Uri musicURI;
...
//                    bRestart.setVisibility(View.VISIBLE);
        ...
        ImageView imageview_music = (ImageView)findViewById(R.id.imageView_music);
...
//        imageview_music.setImageResource(((DataClass)intent.getExtras().get("current_music")).getImgId());
...
//        textView_musicname.startAnimation(animation);
        ...
        try {
//                   mp = MediaPlayer.create(MusicPlayingActivity.this, Uri.parse(Environment.getExternalStorageDirectory().getPath() + "/Samsung/Music/" + str + ".mp3"));
...
//                intent1.putExtra("game_image",(Bitmap)bitmap);
                startActivity(intent1);
...
//        bPause.setText("시작");
        ...
        isPlaying = false;
        mp.stop();
//        Toast.makeText(this, "play_pause", LENGTH_SHORT).show();
    }
//
