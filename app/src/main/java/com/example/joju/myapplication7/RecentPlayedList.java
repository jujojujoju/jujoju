...
public class RecentPlayedList extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String str = pref.getString("recent_array","nonono");
...
//                    datas.add(new DataClass(musicID,name,artist,imgId));
        ...
        DataAdapter adapter = new DataAdapter(RecentPlayedList.this, getLayoutInflater(), datas);
